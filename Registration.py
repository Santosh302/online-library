...
.active:hover
{
 ...
 background:url('image/back4.jpg');
 background-size:100%;
 color:white;
...
<div class="col-sm-12 navbar navbar-expand-sm navbar-light bg-success ">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link menu text-white active" href="Registration.py" style="color:black;font-size:25px;">Registration</a>&nbsp;&nbsp;
...
<div class="row back p-3">
 <div class="col-sm-6">
   <img src="image/lib1.jpg" style="height:420px;width:100%"/>
 </div>
 <form action="regcode.py" method="post">
 <div class="col-sm-6">
   Name:<input type="text" placeholder="enter name" name="text1" style="margin-top:0px;margin-left:5px" required><br/><br/>
   Mobile:<input type="number" placeholder="mobile number" style="margin-left:5px" name="text2"><br/><br/>
   Email:<input type="email" placeholder="Email" style="margin-left:5px" name="text3" required/><br/><br/>
   Passowrd:<input type="password" placeholder="*******" id="" class="" name="text4" style="margin-left:5px" required><br/><br/>
   Gender:<br/> Male &emsp;<input type="radio" name="gender" required/>
        Female&nbsp;<input type="radio"name="gender" required/><br/>
   City:&emsp;<select name="text5">
     <option>Select</option>
          <option value="Andhra Pradesh">Andhra Pradesh</option><option>Arunachal Pradesh</option><option>Assam</option><option>Chhattisgarh</option><option>Goa</option><option>Gujrat</option><option>Haryana</option><option>Jammu and kasmir</option><option>Jharkhand</option><option>Karnataka</option><option>Kerla</option><option>Madhya pradesh</option><option>Manipur</option><option>Meghalaya</option><option>Nagaland</option><option>Sikkim</option><option>Tamil nadu</option><option>Tripura</option><option>Utter pradesh</option><option>Uttarakhand</option><option>West Bangal</option><option>Dadra and Nagar Haveli</option><option>Damman and Diu</option><option>Lakshadwe</option></select><br/><br/>
  </form>
  <input type="submit" name="submit" value ="Submit"/> 
    <input type = "reset" name = "reset"  value = "Reset" />
          &nbsp;<a href="login.py" style="color:white">  you are already Registered..</a>
   </div>
