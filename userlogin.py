...
.back{
 ...
 background:url('image/user1.jpg');
 background-size:100%;
 color:white;
...
<div class="col-sm-12 navbar navbar-expand-sm navbar-light bg-success ">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link menu text-white active" href="login.py" style="color:black;font-size:25px;">User Login</a>&nbsp;&nbsp;
...
<h3 style="color:orange">Login Registered Students :</h3><br/>
<form action="userlogcode.py" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Email address</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="text3"></div>
  <div class="form-group">
